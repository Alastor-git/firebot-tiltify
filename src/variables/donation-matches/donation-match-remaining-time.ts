...
export const TiltifyDonationMatchRemainingTimeVariable: ReplaceVariable = {
    definition: {
        handle: "tiltifyDonationMatchRemainingTime",
        usage: "tiltifyDonationMatchRemainingTime",
        description: "The remaining time before this donation match expires (in seconds). ",
        triggers: {
            event: [
    ...
    evaluator: function (trigger): number {
        ...
        return eventData?.remainingTime ?? 0;
    }
};