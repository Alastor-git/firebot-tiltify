...
export const TiltifyDonationMatchIdVariable: ReplaceVariable = {
    definition: {
        handle: "tiltifyDonationMatchId",
        usage: "tiltifyDonationMatchId",
        description: "The Id of the donation match for this event. ",
        triggers: {
            event: [
