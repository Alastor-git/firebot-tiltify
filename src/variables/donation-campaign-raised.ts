...
export const TiltifyDonationCampaignRaisedVariable: ReplaceVariable = {
    definition: {
    ...
    evaluator: function (trigger) {
        return (trigger.metadata?.eventData as TiltifyDonationEventData)?.campaignInfo?.amountRaised ?? 0;
    }
};