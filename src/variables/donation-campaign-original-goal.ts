...
export const TiltifyDonationCampaignOriginalGoalVariable: ReplaceVariable = {
    definition: {
    ...
    evaluator: function (trigger) {
        return (trigger.metadata?.eventData as TiltifyDonationEventData)?.campaignInfo?.originalGoal ?? 0;
    }
};